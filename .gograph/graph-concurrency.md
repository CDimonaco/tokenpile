...
| `channel_send` | `(*GitHubAuthProvider).Login` | `internal/provider/github_auth.go` | 92 | `errCh <-` |
| `channel_send` | `(*GitHubAuthProvider).Login` | `internal/provider/github_auth.go` | 97 | `codeCh <-` |
| `goroutine` | `(*GitHubAuthProvider).Login` | `internal/provider/github_auth.go` | 100 | `go ` |
| `channel_send` | `(*GitHubAuthProvider).Login` | `internal/provider/github_auth.go` | 102 | `errCh <-` |
