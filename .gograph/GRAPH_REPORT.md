...
- `cmd/tokenpile/cmd_hook.go` (package `main`)
- `cmd/tokenpile/cmd_hook_test.go` (package `main`)
...
- `cmd/tokenpile/cmd_reset.go` (package `main`)
- `cmd/tokenpile/cmd_reset_test.go` (package `main`)
