...
Define the skill files tokenpile installs into coding agents (Claude Code, opencode) so an agent logs its own token usage, and how those files are placed, refreshed and removed.
